...
val ArrowBackIosNewIconVector: ImageVector
    get() {
        if (_arrowBackIosNewIconVector != null) return _arrowBackIosNewIconVector!!
        _arrowBackIosNewIconVector = ImageVector.Builder(
        ...
        return _arrowBackIosNewIconVector!!
    }

private var _arrowBackIosNewIconVector: ImageVector? = null
