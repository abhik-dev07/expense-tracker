...
val CalendarMonthIconVector: ImageVector
    get() {
        if (_calendarMonthIconVector != null) {
            return _calendarMonthIconVector!!
        }
        _calendarMonthIconVector =
            ImageVector.Builder(
                name = "calendar_month",
                defaultWidth = 24.dp,
                defaultHeight = 24.dp,
...
private var _calendarMonthIconVector: ImageVector? = null
