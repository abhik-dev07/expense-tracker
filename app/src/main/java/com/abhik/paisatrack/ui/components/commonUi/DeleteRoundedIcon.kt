...
val DeleteRoundedIconVector: ImageVector
    get() {
        if (_deleteRoundedIconVector != null) {
            return _deleteRoundedIconVector!!
        }
        _deleteRoundedIconVector =
            ImageVector.Builder(
                name = "delete_rounded",
                defaultWidth = 24.dp,
                defaultHeight = 24.dp,
...
private var _deleteRoundedIconVector: ImageVector? = null
