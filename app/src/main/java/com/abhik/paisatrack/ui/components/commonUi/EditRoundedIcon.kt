...
val EditRoundedIconVector: ImageVector
    get() {
        if (_editRoundedIconVector != null) {
            return _editRoundedIconVector!!
        }
        _editRoundedIconVector =
            ImageVector.Builder(
                name = "edit_rounded",
                defaultWidth = 24.dp,
                defaultHeight = 24.dp,
...
private var _editRoundedIconVector: ImageVector? = null
